...
check_classifier(clf, feature_matrix, d.y_train, d.label_list, "Scattering transform + SVC, training")
...
check_classifier(clf, feature_matrix_test, d.y_test, d.label_list, "Scattering transform + SVC")
