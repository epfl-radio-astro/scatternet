...
x = inputs
x = ReducedMorletScattering2D(J,L, max_order = 2,)(x)
...
clf.fit(d.x_train, d.y_train,d.x_val, d.y_val)
check_classifier(clf, d.x_test, d.y_test, d.label_list, "Reduced scattering transform + NN")
